    ...
    public partial class firstInit : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CarsFeatures", x => x.CarFeatureId);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CarsPricings", x => x.CarPricingId);
                    table.ForeignKey(
                        name: "FK_CarsPricings_Cars_CarId",
                        column: x => x.CarId,
                        principalTable: "Cars",
                        principalColumn: "CarId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CarsPricings_Pricings_PricingId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CarsPricings_CarId",
                table: "CarsPricings",
                column: "CarId");

            migrationBuilder.CreateIndex(
                name: "IX_CarsPricings_PricingId",
                table: "CarsPricings",
                column: "PricingId");
        }
